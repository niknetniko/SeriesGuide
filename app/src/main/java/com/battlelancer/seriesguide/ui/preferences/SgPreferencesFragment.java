...
public class SgPreferencesFragment extends PreferenceFragment implements
    ...
    private static final String KEY_SCREEN_BASIC = "screen_basic";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String settings = getArguments() == null ? null
                : getArguments().getString(SeriesGuidePreferences.EXTRA_SETTINGS_SCREEN);
        if (settings == null) {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (KEY_ABOUT.equals(key)) {
            ...
            ft.replace(R.id.containerSettings, new AboutPreferencesFragment());
    ...
    public void onEvent(SeriesGuidePreferences.UpdateSummariesEvent event) {
        if (!isResumed()) {
            return;
        }
        // update summary values not handled by onSharedPreferenceChanged
    ...
    private void setListPreferenceSummary(@Nullable ListPreference listPref) {
        if (listPref == null) {
            return;
        }
    ...
    private static Preference.OnPreferenceChangeListener sNoOpChangeListener = (preference, newValue) -> {
